        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                <div class="h-64 bg-green-100 relative">
                    <img src="https://images.unsplash.com/photo-1501004318641-b39e6451bec6" alt="Snake Plant" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    ...
                    <button class="mt-5 bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-md transition-colors duration-300">
                        Add to Cart
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                <div class="h-64 bg-green-100 relative">
                    <img src="https://images.unsplash.com/photo-1614594975525-e45190c55d0b" alt="Monstera Deliciosa" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                <div class="h-64 bg-green-100 relative">
                    <img src="https://images.unsplash.com/photo-1620311497344-bce841c9c060" alt="Peace Lily" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                <div class="h-64 bg-green-100 relative">
                    <img src="https://images.unsplash.com/photo-1604762524889-3e2fcc145683" alt="Fiddle Leaf Fig" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                <div class="h-64 bg-green-100 relative">
                    <img src="https://images.unsplash.com/photo-1613737693063-a3c03b374aaf" alt="Pothos" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1">
                <div class="h-64 bg-green-100 relative">
                    <img src="https://images.unsplash.com/photo-1632207691143-643e2a9a9361" alt="ZZ Plant" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-semibold text-green-700">ZZ Plant</h3>
                    <p class="text-green-600 font-medium mt-1">$29.99</p>
                    <p class="text-gray-600 mt-3">
                        Nearly indestructible plant with glossy leaves. Thrives in low light and requires minimal watering.
                    </p>
                    <button class="mt-5 bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-md transition-colors duration-300">
                        Add to Cart
                    </button>
