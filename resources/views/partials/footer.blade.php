...
<footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
    <div class="flex flex-col md:flex-row">
        <div class="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
            <h3 class="font-bold text-2xl">Garden Gallery</h3>
            <p class="text-gray-400">Find a variety of selected ornamental plants that will beautify your home
                and environment.
            </p>
            ...
            <form class="flex items-center mt-6">
                <div class="w-full">
                    ...
                    <div class="relative">
                        ...
                        <button type="submit"
                            class="bg-green-500 hover:bg-green-400 text-white px-4 py-2 text-sm font-bold rounded absolute top-0 right-0 my-2 mr-2 cursor-pointer">Subscribe</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
            <h5 class="uppercase tracking-wider font-semibold text-gray-500">Plant Categories</h5>
            <ul class="mt-4">
                <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Indoor
                        Plants</a></li>
                <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Outdoor
                        Plants</a></li>
                <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Hanging
                        Plants</a></li>
            </ul>
        </div>
        ...
        <div class="w-full lg:w-2/6 mt-8 lg:mt-0 lg:mx-4 lg:pr-8">
            ...
            <ul class="mt-4">
                <li>
                    <span class="flex items-center opacity-75 hover:opacity-100">
                        <span>
                        ...
                        <span class="ml-3">
                            Burung Jaya Street, Central Java, IDN 59464
                        </span>
                    </span>
                </li>
                <li class="mt-4">
        ...
        <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
            ...
            <p class="text-sm text-gray-400 mt-12">© 2025 Garden Gallery. <br class="hidden lg:block">All
                Rights
                Reserved.
            </p>
        </div>
